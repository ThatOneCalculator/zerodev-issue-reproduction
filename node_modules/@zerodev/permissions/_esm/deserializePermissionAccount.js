import { KernelFactoryStakerAbi, KernelV3AccountAbi, KernelV3_1AccountAbi, createKernelAccount } from "@zerodev/sdk";
...
export const deserializePermissionAccount = async (client, entryPointAddress, kernelVersion, modularPermissionAccountParams, modularSigner) => {
    ...
    const { index, validatorInitData } = decodeParamsFromInitCode(params.accountParams.initCode, kernelVersion);
...
export const decodeParamsFromInitCode = (initCode, kernelVersion) => {
    let index;
