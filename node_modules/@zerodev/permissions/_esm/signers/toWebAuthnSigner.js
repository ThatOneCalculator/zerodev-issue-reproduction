import { b64ToBytes, base64FromUint8Array, findQuoteIndices, hexStringToUint8Array, isRIP7212SupportedNetwork, parseAndNormalizeSig, uint8ArrayToHexString } from "@zerodev/webauthn-key";
import { SignTransactionNotSupportedBySmartAccount } from "permissionless/accounts";
import { getTypesForEIP712Domain, hashTypedData, validateTypedData } from "viem";
import { encodeAbiParameters } from "viem";
import { toAccount } from "viem/accounts";
import { getChainId, signMessage } from "viem/actions";
import { WEBAUTHN_SIGNER_CONTRACT_V0_0_1, WEBAUTHN_SIGNER_CONTRACT_V0_0_2 } from "../constants.js";
export var WebAuthnSignerVersion;
...
export const getWebAuthnSignerAddress = (webAuthnSignerVersion, webAuthnSignerAddress) => {
...
export const toWebAuthnSigner = async (client, { signerContractAddress, webAuthnKey, webAuthnSignerVersion }) => {
    const webAuthnSignerAddress = getWebAuthnSignerAddress(webAuthnSignerVersion, signerContractAddress);
