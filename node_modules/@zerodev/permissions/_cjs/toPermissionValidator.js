...
async function toPermissionValidator(client, { signer, policies, entryPoint: entryPointAddress, kernelVersion: _, flag = constants_js_1.PolicyFlags.FOR_ALL_VALIDATION }) {
