...
const deserializePermissionAccount = async (client, entryPointAddress, kernelVersion, modularPermissionAccountParams, modularSigner) => {
    ...
    const { index, validatorInitData } = (0, exports.decodeParamsFromInitCode)(params.accountParams.initCode, kernelVersion);
