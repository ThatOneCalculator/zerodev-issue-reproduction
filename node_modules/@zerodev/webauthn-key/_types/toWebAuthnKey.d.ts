...
export declare const toWebAuthnKey: ({ passkeyName, passkeyServerUrl, webAuthnKey, mode, credentials, passkeyServerHeaders }: WebAuthnAccountParams) => Promise<WebAuthnKey>;
