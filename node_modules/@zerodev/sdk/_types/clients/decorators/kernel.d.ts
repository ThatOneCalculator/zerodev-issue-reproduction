...
export type KernelAccountClientActions<entryPoint extends EntryPoint, TChain extends Chain | undefined = Chain | undefined, TSmartAccount extends KernelSmartAccount<entryPoint> | undefined = KernelSmartAccount<entryPoint> | undefined> = SmartAccountActions<entryPoint, TChain, TSmartAccount> & {
     ...
     * @returns The [Transaction](https://viem.sh/docs/glossary/terms.html#transaction) hash. {@link SendTransactionReturnType}
     */
    invalidateNonce: <TChainOverride extends Chain | undefined = Chain | undefined>(args: InvalidateNonceParameters<entryPoint, TChain, TSmartAccount, TChainOverride>) => Promise<Hash>;
    /**
     ...
     * @returns nonce
     */
    getKernelV3ModuleCurrentNonce: <TChainOverride extends Chain | undefined = Chain | undefined>(args: GetKernelV3ModuleCurrentNonceParameters<entryPoint, TChain, TSmartAccount, TChainOverride>) => Promise<number>;
};
