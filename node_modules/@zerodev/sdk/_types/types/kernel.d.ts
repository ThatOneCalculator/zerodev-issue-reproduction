...
export type KernelPluginManager<entryPoint extends EntryPoint> = KernelValidator<entryPoint> & {
    ...
    signUserOperationWithActiveValidator: (userOperation: UserOperation<GetEntryPointVersion<entryPoint>>) => Promise<Hex>;
};
...
export type GetKernelVersion<entryPoint extends EntryPoint> = entryPoint extends ENTRYPOINT_ADDRESS_V06_TYPE ? KERNEL_V2_VERSION_TYPE : KERNEL_V3_VERSION_TYPE;
