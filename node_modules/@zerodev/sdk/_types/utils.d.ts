...
export declare const validateKernelVersionWithEntryPoint: <entryPoint extends EntryPoint>(entryPointAddress: entryPoint, kernelVersion: GetKernelVersion<entryPoint>) => void;
