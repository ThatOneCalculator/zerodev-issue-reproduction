...
function kernelAccountClientActions({ middleware }) {
    return (client) => ({
        ...
        invalidateNonce: async (args) => (0, invalidateNonce_js_1.invalidateNonce)(client, {
            ...args,
            middleware
        }),
        getKernelV3ModuleCurrentNonce: async (args) => (0, getKernelV3ModuleCurrentNonce_js_1.getKernelV3ModuleCurrentNonce)(client, {
            ...args,
            middleware
        })
    });
