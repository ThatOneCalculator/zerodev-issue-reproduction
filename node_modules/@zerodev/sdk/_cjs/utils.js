...
exports.satisfiesRange = exports.validateKernelVersionWithEntryPoint = exports.getExecMode = exports.fixSignedData = exports.getERC20PaymasterApproveCall = exports.hasKernelFeature = exports.KERNEL_FEATURES_BY_VERSION = exports.KERNEL_FEATURES = void 0;
...
const validateKernelVersionWithEntryPoint = (entryPointAddress, kernelVersion) => {
    if ((entryPointAddress === permissionless_1.ENTRYPOINT_ADDRESS_V06 &&
        !(0, semver_1.satisfies)(kernelVersion, ">=0.2.2 || <=0.2.4")) ||
        (entryPointAddress === permissionless_1.ENTRYPOINT_ADDRESS_V07 &&
            !(0, semver_1.satisfies)(kernelVersion, ">=0.3.0"))) {
